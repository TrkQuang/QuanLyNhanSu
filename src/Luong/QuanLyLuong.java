...
/**
 * QuanLyLuong: Quản lý bảng lương tháng của nhân sự
...
public class QuanLyLuong {
    ...
    public Luong tinhLuongTuDong(String maNS, int thang, int nam) {
        ...
        ChamCongThang congThang = DataCenter.qlcc.timCongThang(maNS, thang, nam);
        if (congThang != null) {
        ...
        // 1.6. Tính lương sau hệ số
        luong.tinhLuongSauHeSo();
        
        // 2. Lấy thưởng từ module Thuong
        double thuongModule = DataCenter.qlThuong.tinhTongThuongTheoNhanSuTrongThang(maNS, thang, nam);
        luong.setThuongModule(thuongModule);
        
        // 3. Lấy thưởng dự án từ module PhongBan
        double thuongDuAn = DataCenter.qlPhongBan.tinhTongThuongPhanCongTheoThang(maNS, thang, nam);
