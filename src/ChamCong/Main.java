...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            System.out.println("3. Tổng hợp chấm công tháng (từ DataCenter) và lưu ra file");
            ...
            switch (chon) {
                case 1:
                    ...
                    break;
                case 2:
                    DataCenter.qlcc.xuatDanhSachNgay();
                    break;
                case 3:
                    DataCenter.qlct.tongHopTuDataCenter();
                    break;
                case 4:
                    DataCenter.qlct.xuatBangTongHopTuFile();
                    break;
                case 5:
                    DataCenter.qlcc.xoaDuLieuChamCong();
                    break;
                case 6:
                    DataCenter.qlct.xoaDuLieuCongThang();
                    break;
                case 0:
